...
- Downloading required models and extra data from [OneDrive](https://cuhko365-my.sharepoint.com/:u:/g/personal/220019015_link_cuhk_edu_cn/EfK1lFQAEN1Dsn6VHUxj2acBoROTqsnGQO1_wjNyDaAW9g?e=SwpVLQ). After unzipping the above file, the directory structure of `./rabit_data` is expected as follows,
